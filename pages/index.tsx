export default function Home() {
  return (
    <div className="bg-slate-200 py-20 px-20 flex flex-col space-y-5 min-h-screen">
      <div className="bg-white p-10 rounded-2xl shadow-xl">
        <span className="font-semibold text-3xl">Select Item</span>
        <ul>
          {[1, 2, 3, 4].map((i) => (<div className="flex justify-between my-2">
      ...
      <div className="bg-white overflow-hidden rounded-2xl shadow-xl group">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          <div className="flex relative -top-16 items-end justify-between">
            ...
            <div className="h-24 w-24 bg-zinc-400 rounded-full group-hover:bg-red-400 transition-colors" />
            <div className="flex flex-col items-center">
      ...
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        <div className="flex mb-5 justify-between items-center">
          ...
          <div className="space-x-3">
            <span>⭐️ 4.9</span>
            <span className="shadow-xl p-2 ronded-md">💖</span>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="bg-blue-500 text-center text-xs text-white rounded-lg px-5 py-2">Add to cart</button>
        </div>
      </div>
    </div >
  );
